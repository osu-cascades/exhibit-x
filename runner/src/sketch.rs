use std::{fmt::Display, path::PathBuf, process::{Child, Command, Stdio}};
...
impl Sketch {
    ...
    pub fn kill_all() {
        Command::new("killall").arg("/home/exhibitx/.local/share/applications/processing-3.5.4/java/bin/java").spawn().unwrap();
    }
...
impl Display for Sketch {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "{}, located at {}", self.name, self.path.to_string_lossy())
    }
}
